...
```bash
conda create -f env/conda-specfiles/quarto-env_<platform>_conda_spec.txt -n quarto-env
```
...
```bash
conda create -f env/conda-specfiles/jupyter-env_<platform>_conda_spec.txt -n jupyter-env
...
```bash
conda create -f env/conda-specfiles/snakemake-env_<platform>_conda_spec.txt -n snakemake-env
...
```bash
conda create -f env/conda-specfiles/nextflow-env_<platform>_conda_spec.txt -n nextflow-env
