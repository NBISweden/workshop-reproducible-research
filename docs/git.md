...
You will now be redirected to the repository page. It is an empty repository, so there is not much to see yet. We want to add some content (files) to the repository. To do that we will first *clone* the repository locally:
