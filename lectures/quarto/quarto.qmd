...
## Quarto connects code with results {.smaller}
...
::: {.fragment}
_Many IDEs like VS Code and R Studio also have [buttons]{.green} to render
Quarto documents._
:::
...
- [Books]{.green}, [websites]{.green} and [blogs]{.green}
...
- R Markdown will continued to be supported, but Quarto is the focus of new
