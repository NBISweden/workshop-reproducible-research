...
Snakefile         recipe to create a project container
```
]
...
Another example: <a href="https://github.com/snakemake-workflows/cookiecutter-snakemake-workflow" .green[snakemake-workflows/template] </a>
