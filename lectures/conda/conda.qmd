...
## Conda, Anaconda, Miniconda, Miniforge... {.smaller}
...
- [Miniconda]{.green}: A minimal installer for Conda, pre-configured to use the `default` channel
- [Miniforge]{.green}: A minimal installer for Conda, pre-configured to use the `conda-forge` channel
:::
