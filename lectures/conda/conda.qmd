---
title: 'Managing software environments with <br> <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/Conda_logo.svg/2056px-Conda_logo.svg.png" style="width:50%;padding: 25px 25px 25px 25px;">'
...
::: {.justify-center}
Full reproducibility requires the possibility to recreate the system that was
originally used to generate the results.
:::
