...
.small[Sczyrba *et al* Nature Methods (2017) 14:1063–1071, [doi.org/10.1038/nmeth.4458](https://doi.org/10.1038/nmeth.4458)]
...
.tiny[Check OS on local machine]
...
.tiny[Run a container and check OS version]
...
<img src="https://sylabs.io/guides/3.7/user-guide/_static/logo.png" style="width:10%;"/>

an open source container platform suitable for HPC clusters

[https://sylabs.io/guides/3.7/user-guide/](https://sylabs.io/guides/3.7/user-guide/)
...
| <img src="https://www.docker.com/sites/default/files/mono-vertical.png" style="width:25%;"/> | <img src="https://sylabs.io/guides/3.7/user-guide/_static/logo.png" style="width:25%;"/> |
| ------ | ----------- |
