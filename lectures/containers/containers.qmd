...
title: 'Working with containers
        <img src="images/docker-logo.webp" height="250px" style="float:center; padding: 15px 15px 15px 15px;"/>
        <img src="https://sylabs.io/guides/3.0/user-guide/_static/logo.png" height="250px" style="float:center; padding: 15px 15px 15px 15px;"/>
        <img src="https://apptainer.org/docs/user/main/_static/logo.png" height="250px" style="float:center; padding: 15px 15px 15px 15px;"/>'
...
> (2015) 4:33, [doi:10.1186/s13742-015-0073-6](https://doi.org/10.1186/s13742-015-0073-6)_]
...
```{.bash code-line-numbers="1-3|4-11|7-8"}
$ docker run \
