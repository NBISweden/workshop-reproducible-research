...
* Don't create different versions of the input data - write a .green[script], .green[R Markdown] document or .green[Jupyter] notebook if you need to preprocess your input data so that the steps can be recreated
...
* Write scripts, .green[R Markdown] documents or .green[Jupyter] notebooks for reproducible results to connect raw data to final results
