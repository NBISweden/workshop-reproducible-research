...
- **Marimo** - Similar to Jupyter, but pure python. Tries to eliminate common
  problems with Jupyter notebooks.
- **R Markdown** – Developed by Posit (previously RStudio), but largely
  superseded by Quarto
...
- Online Drop-in: [https://meet.nbis.se/dropin](https://meet.nbis.se/dropin)
- Every [Tuesday, 14.00-15.00]{.green} (except public holidays)
- Check [https://www.nbis.se/get-support/talk-to-us](https://www.nbis.se/get-support/talk-to-us) for more info
