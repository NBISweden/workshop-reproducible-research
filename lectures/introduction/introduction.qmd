...
![Verena Kutchera](images/verena-kutschera.png)
...
::: {.incremental}
 ...
 - Provides hands-on bioinformatic support, training, infrastructure and a weekly
   drop-in
 - Situated in Lund, Gothenburg, Linköping, Stockholm, Uppsala and Umeå
...
::: {.column}
![](images/reproducibility-study-2.jpg)
:::
::::
...
irreproducible.^[*"Drug development: Raise standards for preclinical cancer
...
*Replication of 18 articles on microarray-based experiments published in Nature
Genetics in 2005–2006* ^[*Ioannidis et al. (2009) "Repeatability of published
microarray gene expression analyses", Nature Genetics 41, doi:10.1038/ng.295*]
...
*Science* could be reproduced. ^[*Stodden et. al (2018). "An empirical analysis
