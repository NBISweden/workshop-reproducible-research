...
done so already. Place yourself in the `tutorials/rmarkdown/` directory,
activate your `rmarkdown-env` Conda environment and start RStudio from the
command line (type `rstudio &`).
