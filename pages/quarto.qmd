...
::: {.callout-note title="A note on Python in-line code"}
...
::: {.callout-note title="Making sure your Jupyter engine is recognised"}
...
- Add a suitable label, _e.g._ `label: fig-penguins` to the chunk options.
