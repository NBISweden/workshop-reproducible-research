...
If you're running the workshop through GitHub Codespaces, then you can open the
jupyter lab server by holding the `Ctrl`-key (`Cmd`-key on Mac) and clicking the
...
case-study Snakemake workflow used in the Snakemake tutorial. This is a
