---
title: "Take-down"
subtitle: "How to remove the tools that have been installed during the workshop"
pagetitle: "Take-down | Tools for Reproducible Research"
description: ""
date: ""
format: html
---
...
GitHub repo. This can be removed like any other directory; via Finder, Explorer
or `rm -rf workshop-reproducible-research`. Note that this will also delete
hidden directories such as `.git`, which contains the history of the repo.
