...
The course was held `r params$location`, `r params$month_start` `r
params$day_start` - `r params$month_end` `r params$day_end` `r params$year`. It
consisted of lectures, computer exercises and group discussions.
